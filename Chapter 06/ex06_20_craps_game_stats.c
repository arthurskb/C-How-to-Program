// a - Obtained from the code below, but the wins almost always comes from first
// roll(241) b - Obtained from the code below, but the loses almost always comes
// from first(110), second(109) and third roll(86) c - Its close to 50/50 d - 3
// rolls e - No, the chances of winning decrease with the length of the game.
#include <stdio.h>
#include <stdlib.h>
