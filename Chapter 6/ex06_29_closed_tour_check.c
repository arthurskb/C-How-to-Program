...
int main() {
  ...
  for (int r = 0; r < 8; r++) {
    for (int c = 0; c < 8; c++) {
        ...
        for (size_t j = 0; j < 8; j++) {
          ...
          if (((nextRow >= 0 && nextRow <= 7) &&
            ...
            for (size_t k = 0; k < 8; k++) {
              ...
              if (((nextNextRow >= 0 && nextNextRow <= 7) &&
                   (nextNextCollum >= 0 && nextNextCollum <= 7)) &&
                  (board[nextNextRow][nextNextCollum] == 0)) {
                if (accessibility[nextNextRow][nextNextCollum] <
                    minFutureAccess) {
      ...
      if (currentRow == r && currentCollum == c)
