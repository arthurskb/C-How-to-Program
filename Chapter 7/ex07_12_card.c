...
void deal(unsigned int wDeck[][FACES], const char *wFace[], const char *wSuit[],
          unsigned int pokerHandSuits[],
          unsigned int pokerHandFaces[]);  // dealing doesn't modify the arrays
void checkHand(const unsigned int pokerHandSuits[],
...
// deal cards in deck
void deal(unsigned int wDeck[][FACES], const char *wFace[], const char *wSuit[],
          unsigned int pokerHandSuits[], unsigned int pokerHandFaces[]) {
