...
void deal(unsigned int wDeck[][FACES], const char *wFace[],
        const char *wSuit[], unsigned int pokerHandSuits[], unsigned int pokerHandFaces[]); // dealing doesn't modify the arrays
void checkHand(const unsigned int pokerHandSuits[], const unsigned int pokerHandFaces[]);

int main(void)
{
        // initialize deck array
        unsigned int deck[SUITS][FACES] = { 0 };
        unsigned int pokerHandSuits[CARDS] = { 0 };
	unsigned int pokerHandFaces[CARDS] = { 0 };
        ...
        deal(deck, face, suit, pokerHandSuits, pokerHandFaces); // deal the deck
	checkHand(pokerHandSuits, pokerHandFaces);
...
// deal cards in deck
void deal(unsigned int wDeck[][FACES], const char *wFace[],
        const char *wSuit[], unsigned int pokerHandSuits[], unsigned int pokerHandFaces[])
{
                ...
                for (size_t row = 0; row < SUITS; ++row) {
                        ...
                        for (size_t column = 0; column < FACES; ++column) {
                                ...
                                if (wDeck[row][column] == card) {
                                        *(pokerHandSuits + card) = row;
					*(pokerHandFaces + card) = column; 
                                }
                        }
                }
        }
